...
import { signedUpActivities } from '@/composables/useAuth'
</script>
...
.timeline-title { font-size: 11.5px; font-weight: 800; letter-spacing: 0.8px; text-transform: uppercase; color: #ffb74d; margin-bottom: 10px; }
...
.timeline-act-name { font-size: 11px; color: rgba(255,255,255,0.85); line-height: 1.4; }
