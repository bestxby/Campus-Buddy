...
验证时间: 2026-05-29 13:25:13

## 1. 验证结果概览

| 模块 | 验证项目 | 耗时 (ms) | 状态 | 备注 |
| --- | --- | --- | --- | --- |
| 后端 | Python 算法测试 (pytest) | 692.4 | ✅ PASSED | - |
| 前端 | Vitest 组件与状态测试 | 3119.3 | ✅ PASSED | - |
| 前端 | Vite 生产环境构建打包 | 936.5 | ✅ SUCCESS | - |
...
[Performance] 2-hop buddy recommendation for '严丽' took 0.2230 ms.
[Performance] Jaccard-ranked buddy recommendation for '严丽' took 1.2342 ms.
[Performance] BFS find_path from '严丽' to '严华杰' took 0.3088 ms. Path length: 3
.........
...
[1m[30m[46m RUN [49m[39m[22m [36mv4.1.7 [39m[90mE:/学习/大二下课程/数据结构与算法/数据结构大作业/Campus-Buddy/frontend[39m
 ...
 [32m✓[39m src/test/graph-algorithms.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 6[2mms[22m[39m
 [32m✓[39m src/test/graph-store.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 9[2mms[22m[39m
 [32m✓[39m src/test/auth-store.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 17[2mms[22m[39m
 [32m✓[39m src/test/components/AllActivities.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 33[2mms[22m[39m
 [32m✓[39m src/test/components/BuddyList.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 51[2mms[22m[39m
...
[2m   Start at [22m 13:25:10
[2m   Duration [22m 2.08s[2m (transform 1.14s, setup 0ms, import 2.54s, tests 228ms, environment 6.28s)[22m
