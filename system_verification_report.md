...
验证时间: 2026-05-30 00:29:52

## 1. 验证结果概览

| 模块 | 验证项目 | 耗时 (ms) | 状态 | 备注 |
| --- | --- | --- | --- | --- |
| 后端 | Python 算法测试 (pytest) | 661.1 | ✅ PASSED | - |
| 前端 | Vitest 组件与状态测试 | 3561.7 | ✅ PASSED | - |
| 前端 | Vite 生产环境构建打包 | 949.6 | ✅ SUCCESS | - |
...
[Performance] 2-hop buddy recommendation for '严丽' took 0.2067 ms.
[Performance] Jaccard-ranked buddy recommendation for '严丽' took 1.1444 ms.
[Performance] BFS find_path from '严丽' to '严华杰' took 0.2369 ms. Path length: 3
.........
...
[1m[30m[46m RUN [49m[39m[22m [36mv4.1.7 [39m[90mE:/学习/大二下课程/数据结构与算法/数据结构大作业/Campus-Buddy/frontend[39m
 ...
 [32m✓[39m src/test/graph-algorithms.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 11[2mms[22m[39m
 ...
 [32m✓[39m src/test/auth-store.test.ts [2m([22m[2m11 tests[22m[2m)[22m[32m 25[2mms[22m[39m
 [32m✓[39m src/test/components/AllActivities.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 62[2mms[22m[39m
 [32m✓[39m src/test/components/RecommendedActivities.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 66[2mms[22m[39m
 [32m✓[39m src/test/components/BuddyList.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 94[2mms[22m[39m
...
[22m[39mApp wrapper HTML content length: [33m176[39m
 ...
 [32m✓[39m src/test/App.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 60[2mms[22m[39m

[2m Test Files [22m [1m[32m8 passed[39m[22m[90m (8)[39m
[2m      Tests [22m [1m[32m32 passed[39m[22m[90m (32)[39m
[2m   Start at [22m 00:29:49
[2m   Duration [22m 2.56s[2m (transform 1.99s, setup 202ms, import 3.70s, tests 344ms, environment 8.67s)[22m
...
dist/assets/style-B5HYt0dy.css              13.09 kB │ gzip:  3.44 kB
dist/assets/main-DZspIcjL.css               96.29 kB │ gzip: 15.35 kB
dist/assets/preview-B9fHu20Q.js              0.90 kB │ gzip:  0.70 kB
dist/assets/style-VP_LE33V.js                9.65 kB │ gzip:  4.20 kB
dist/assets/d3-vendor-7qNyeggi.js           61.04 kB │ gzip: 20.90 kB
dist/assets/vue-vendor-CKem-9up.js          77.84 kB │ gzip: 30.61 kB
dist/assets/main-DpmVdqvt.js               238.65 kB │ gzip: 63.42 kB
