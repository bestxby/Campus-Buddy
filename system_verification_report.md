...
验证时间: 2026-05-29 16:14:34

## 1. 验证结果概览

| 模块 | 验证项目 | 耗时 (ms) | 状态 | 备注 |
| --- | --- | --- | --- | --- |
| 后端 | Python 算法测试 (pytest) | 868.5 | ✅ PASSED | - |
| 前端 | Vitest 组件与状态测试 | 3301.1 | ✅ PASSED | - |
| 前端 | Vite 生产环境构建打包 | 874.8 | ✅ SUCCESS | - |
...
[Performance] 2-hop buddy recommendation for '严丽' took 0.1903 ms.
[Performance] Jaccard-ranked buddy recommendation for '严丽' took 1.1092 ms.
[Performance] BFS find_path from '严丽' to '严华杰' took 0.2920 ms. Path length: 3
.........
...
[1m[30m[46m RUN [49m[39m[22m [36mv4.1.7 [39m[90mE:/学习/大二下课程/数据结构与算法/数据结构大作业/Campus-Buddy/frontend[39m
 ...
 [32m✓[39m src/test/auth-store.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 15[2mms[22m[39m
 [32m✓[39m src/test/components/AllActivities.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 28[2mms[22m[39m
 [32m✓[39m src/test/components/RecommendedActivities.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 42[2mms[22m[39m
 [32m✓[39m src/test/components/BuddyList.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 42[2mms[22m[39m
...
[22m[39mApp wrapper HTML content length: [33m176[39m
 ...
 [32m✓[39m src/test/App.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 42[2mms[22m[39m

[2m Test Files [22m [1m[32m7 passed[39m[22m[90m (7)[39m
[2m      Tests [22m [1m[32m22 passed[39m[22m[90m (22)[39m
[2m   Start at [22m 16:14:31
[2m   Duration [22m 2.14s[2m (transform 1.22s, setup 0ms, import 2.34s, tests 182ms, environment 7.46s)[22m
...
dist/assets/main-2rRr4xGk.css        94.73 kB │ gzip: 15.38 kB
...
dist/assets/main-CIgYAyow.js        198.21 kB │ gzip: 57.26 kB
