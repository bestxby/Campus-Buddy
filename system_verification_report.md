...
验证时间: 2026-05-29 17:00:04

## 1. 验证结果概览

| 模块 | 验证项目 | 耗时 (ms) | 状态 | 备注 |
| --- | --- | --- | --- | --- |
| 后端 | Python 算法测试 (pytest) | 781.4 | ✅ PASSED | - |
| 前端 | Vitest 组件与状态测试 | 3217.0 | ✅ PASSED | - |
| 前端 | Vite 生产环境构建打包 | 1003.0 | ✅ SUCCESS | - |
...
[Performance] 2-hop buddy recommendation for '严丽' took 0.2433 ms.
[Performance] Jaccard-ranked buddy recommendation for '严丽' took 1.5653 ms.
[Performance] BFS find_path from '严丽' to '严华杰' took 0.3250 ms. Path length: 3
.........
...
[1m[30m[46m RUN [49m[39m[22m [36mv4.1.7 [39m[90mE:/学习/大二下课程/数据结构与算法/数据结构大作业/Campus-Buddy/frontend[39m
 ...
 [32m✓[39m src/test/graph-algorithms.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 10[2mms[22m[39m
 [32m✓[39m src/test/graph-store.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 15[2mms[22m[39m
 [32m✓[39m src/test/report-generator.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 15[2mms[22m[39m
 [32m✓[39m src/test/auth-store.test.ts [2m([22m[2m11 tests[22m[2m)[22m[32m 31[2mms[22m[39m
 [32m✓[39m src/test/components/AllActivities.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 38[2mms[22m[39m
 [32m✓[39m src/test/components/RecommendedActivities.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 48[2mms[22m[39m
 [32m✓[39m src/test/components/BuddyList.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 74[2mms[22m[39m
...
[22m[39mApp wrapper HTML content length: [33m176[39m
 ...
 [32m✓[39m src/test/App.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 50[2mms[22m[39m

[2m Test Files [22m [1m[32m8 passed[39m[22m[90m (8)[39m
[2m      Tests [22m [1m[32m32 passed[39m[22m[90m (32)[39m
[2m   Start at [22m 17:00:01
[2m   Duration [22m 2.17s[2m (transform 1.55s, setup 0ms, import 3.16s, tests 281ms, environment 7.51s)[22m
